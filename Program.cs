...
namespace DOTNETPRACTICE
{
    static class TheBomb
    {
        ...
        static public void Serialnumset()
        {
            ...
            if (isodd == "yes")
            {
                TheBomb.Serialnumodd = 1;
            }
            else
            {
                TheBomb.Serialnumodd = 0;
            }
        }
        ...
        static public void indicatorCARset()
        {
            ...
            {
                TheBomb.indicatorCAR = 1;
            }
            else
            {
                TheBomb.indicatorCAR = 0;
            }
        }
        static public void indicatorFRKset()
        {
            ...
            {
                TheBomb.indicatorFRK = 1;
            }
            else
            {
                TheBomb.indicatorFRK = 0;
            }
        }
        ...
        static public void parallelportset()
        {
            ...
            if (parallelport == "yes")
            {
                TheBomb.hasparallelport = 1;
            }
            else
            {
                TheBomb.hasparallelport = 0;
            }
        }
    }
    class Program
    {
        class Solver
        {
            ...
            static public void modwires()
            {
                ...
                //Console.WriteLine($"this is wirenums val: {wirenum}"); //For Debugging
                ...
                if (wirenum == 3)
                {
                    if (wirecolorcount(wirecolorarr, "red") == 0)
                    {
                    ...
                    else if (wirecolorcount(wirecolorarr, "blue") > 1)
                    {
                ...
                {
                    if (TheBomb.Serialnumodd == -1)
                    {
                        TheBomb.Serialnumset();
                    }
                    if (wirecolorcount(wirecolorarr, "red") > 1 && TheBomb.Serialnumodd == 1)
                    {
                        Console.WriteLine("Cut the last red wire");
                    }
                    else if (wirecolorcount(wirecolorarr, "red") == 0 && wirecolorarr[wirenum - 1] == "yellow")
                    {
                    ...
                    else if (wirecolorcount(wirecolorarr, "yellow") > 1)
                    {
                        Console.WriteLine("Cut the last wire");
                    }
                    else
                ...
                else if (wirenum == 5)
                {
                    ...
                    if (wirecolorarr[wirenum-1]=="black" && TheBomb.Serialnumodd == 1)
                    {
                        Console.WriteLine("Cut the fourth wire");
                    }
                    else if (wirecolorcount(wirecolorarr, "red") == 1 && wirecolorcount(wirecolorarr, "yellow") > 1)
                    {
                        Console.WriteLine("Cut the first wire");
                    }
                    else if (wirecolorcount(wirecolorarr, "black") == 0)
                    {
                        Console.WriteLine("Cut the second wire");
                    }
                    else
                ...
                else
                {
                    ...
                    if (wirecolorcount(wirecolorarr, "yellow") == 0 && TheBomb.Serialnumodd == 1)
                    {
                        Console.WriteLine("Cut the third wire");
                    }
                    else if (wirecolorcount(wirecolorarr, "yellow") == 1 && wirecolorcount(wirecolorarr, "white") > 1)
                    {
                        Console.WriteLine("Cut the fourth wire");
                    }
                    else if (wirecolorcount(wirecolorarr, "red") == 0)
                    {
                        Console.WriteLine("Cut the last wire");
                    }
                    else
            ...
            static public void modthebutton()
            {
                ...
                if (TheBomb.Batterynum == -1)
                {
                    TheBomb.Batterynumset();
                }
                if (TheBomb.indicatorCAR == -1)
                {
                    TheBomb.indicatorCARset();
                }
                if (TheBomb.indicatorFRK == -1)
                {
                    TheBomb.indicatorFRKset();
                }
                ...
                else if (TheBomb.Batterynum > 1 && buttonword == "detonate")
                {
                    Console.WriteLine("Press and immediately release the button");
                }
                else if (buttoncolor == "white" && TheBomb.indicatorCAR == 1)
                {
                    Console.WriteLine("Hold the button\nIf blue strip: Release at 4\nIf yellow strip: Release at 5\nIf other strip: Release at 1");
                }
                else if (TheBomb.Batterynum > 2 && TheBomb.indicatorFRK == 1)
                {
                    Console.WriteLine("Press and immediately release the button");
                }
            ...
            static public void modkeypad()
            {
                Console.WriteLine("Please refer to the Bomb Manual");
            }
            static public void modsimon()
            {
                bool validinput = false;
                int strikenum = -1;

                if (TheBomb.hasvowel == -1)
                {
                    TheBomb.vowelset();
                }
            ...
            static public void modwhosfirst()
            {
                ...
                if (topword == "yes" || topword == "nothing" || topword == "led" || topword == "they are")
                {
                    ...
                    whosfirstwordschecker(buttonword);
                }
            ...
            static public void complicatedwireschecker(string wirered, string wireblue, string hasstar, string hasled)
            {
                ...
                else if (((wirered == "yes" && wireblue == "no" && hasstar == "no" && hasled == "no") || (wirered == "no" && wireblue == "yes" && hasstar == "no" && hasled == "no") || (wirered == "yes" && wireblue == "yes" && hasstar == "no" && hasled == "no") || (wirered == "yes" && wireblue == "yes" && hasstar == "no" && hasled == "yes")) && (TheBomb.Serialnumodd==0))
                {
                    Console.WriteLine("Cut the wire");
                }
                else if (((wirered == "no" && wireblue == "yes" && hasstar == "no" && hasled == "yes") || (wirered == "yes" && wireblue == "yes" && hasstar == "yes" && hasled == "no") || (wirered == "no" && wireblue == "yes" && hasstar == "yes" && hasled == "yes")) && (TheBomb.hasparallelport == 1))
                {
                    Console.WriteLine("Cut the wire");
                }
                else if (((wirered == "yes" && wireblue == "no" && hasstar == "no" && hasled == "yes") || (wirered == "yes" && wireblue == "no" && hasstar == "yes" && hasled == "yes") || (wirered == "no" && wireblue == "no" && hasstar == "yes" && hasled == "yes")) && (TheBomb.Batterynum >= 2))
                {
                    Console.WriteLine("Cut the wire");
                }
                else
            ...
            static public void modcomplicatedwires()
            {
                string isdone = "def";
                ...
                if (TheBomb.hasparallelport == -1)
                {
                    TheBomb.parallelportset();
                }
                ...
                while (isdone == "def" || isdone == "next")
                {
                    ...
                    complicatedwireschecker(wirered, wireblue, hasstar, hasled);
            ...
            static public void modwiresequence()
            {
                ...
                while (!isdone)
                {
                    ...
                    while (!validinput)
                    {
                        ...
                        if (wirecolor == "red" || wirecolor == "blue" || wirecolor == "black")
                        {
                            ...
                            {
                                redcounter++;
                                wiresequencechecker(wirecolor, redcounter);
                            }
                            else if (wirecolor == "blue")
                            {
                                bluecounter++;
                                wiresequencechecker(wirecolor, bluecounter);
                            }
                            else
                            {
                                blackcounter++;
                                wiresequencechecker(wirecolor, blackcounter);
                            }
                        }
        ...
        static void Main(string[] args)
        {
            ...
            while (!isdone)
            {
                ...
                {
                    Solver.modcomplicatedwires();
                }
                else if (modname == "wire sequence")
                {
                    Solver.modwiresequence();
                }
